...
Unfortunately, GitHub Pages is not smart enough to use React’s 'root' component out of the box, therefore still you will not see this page working on the GitHub. Feel free to clone and download, and run it locally.
